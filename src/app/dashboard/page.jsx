...
const DashboardPage = () => {
     ...
     return (
          <div className='max-w-7xl mx-auto my-20 px-5 lg:px-0'>
               ...
               <div>
                    {
                         isPending ? <p className='text-[#54bbb8] py-20 text-center'>Loading Data</p> : active === "my-bookings" ? <MyBookings/> : <MyProfiles/>  
                    }
               </div>
          </div>
     );
