      ...
      <div className="max-w-7xl mx-auto pt-10">
        <div className="flex justify-between items-center">
          <div>
            ...
            <h1 className="text-5xl font-semibold pb-2">Your Health,</h1>
            <h1 className="text-5xl font-semibold bg-linear-to-r from-[#01cfbe] to-[#54bbb8] bg-clip-text text-transparent pb-5">Our First Priority</h1>
            <p className="max-w-150 text-gray-500 pb-5">Book appoinments with trusted doctors online. Quick, easy and secure healthcare for you and your family.</p>
          ...
          <div>
            <Image src='/doctor-home-01.png' alt="Doctor Image" className="h-120 w-190" height={2000} width={2000}></Image>
          </div>
        </div>
