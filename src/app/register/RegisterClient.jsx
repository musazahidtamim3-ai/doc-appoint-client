          ...
          <div className='min-h-screen px-5 lg:px-0'>
               <Form onSubmit={handleSubmit(handleRegisterFunc)} className="max-w-2xl mx-auto my-20 space-y-4 rounded-lg border border-border bg-surface p-5 md:p-10">
                    ...
                    <TextField>
                         ...
                         <Input className="rounded-md border-border/60" placeholder="Paste your photo url" {...register("photo", { required: true })} />
                         {errors.photo && <p className='text-red-500'>This field is required</p>}
                         <FieldError className="text-xs" />
                    </TextField>
                    <TextField>
                         <Label className="text-sm font-medium">Password</Label>
                         <Input className="rounded-md border-border/60" placeholder="Give a password for security" {...register("password", {
                    ...
                    <div className='flex justify-center text-sm items-center gap-3'>
                         ...
                         <Link href={'/login'}><p className='text-red-500'>Login</p></Link>
                    </div>
               </Form>
          </div>
     );
